...
const DEBUG = {
    ...
    checkpoint1() {
        ...
        TITLE.scrolls();
        let invItems = ["GoldCoin", "Mushroom", "LittleChicken", "LittleChicken", "Mushroom", "Fish", "Leotard", "LeoPumps", "Poison"];
